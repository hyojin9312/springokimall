	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<div class="container" style="width:500px; height:400px; background-color: white; margin-top: 30px;">
    			<form class="form-signin" id="loginfrm" action="login" method="post">       
      				<h2 class="form-signin-heading">Please login</h2>
      				<input type="text" class="form-control" style="margin-bottom: 15px" id="admin_id" name="admin_id" placeholder="Id" required autofocus/>
      				<input type="password" class="form-control" style="margin-bottom: 15px" id="admin_pw" name="admin_pw" placeholder="Password" required/>      
