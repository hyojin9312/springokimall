	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					Admin Page <small>Product read</small>
				</h1>
				<ol class="breadcrumb">
					<li>
					...
					<div class="col-md-12">
						...
						<div class="box box-primary">
							<div class="box-header">
								<h3 class="box-title">PRODUCT READ</h3>
							</div>
							<!-- /.box-header -->
							...
							<div class="box-body">
								<div class="form-group">
									...
									<span class="form-control" style="width:40%; margin-right:10px; display:inline-block;">${vo.cate_par}</span>
									<span class="form-control" style="width:40%;  display:inline-block;">${vo.cate_code}</span>
									
								</div>
								<div class="form-group">
									<label for="exampleInputEmail1">Product Name</label> 
									<span class="form-control">${vo.gds_name}</span>
								</div>
								<div class="form-group">
									<label for="exampleInputEmail1">Company</label> 
									<span class="form-control">${vo.gds_make}</span>
								</div>
								<div class="form-group">
									...
									<span class="form-control" style="width:40%; margin-right:10px; display:inline-block;">${vo.gds_pric}</span>
									<span class="form-control" style="width:40%; display:inline-block;">${vo.gds_disc}</span>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<span class="form-control"><c:out value="${vo.gds_imag}" /></span>
									<!-- TODO: 이미지파일 처리 필요 -->
									<!-- 
									<input
								...
								<div class="form-group">
									...
									<span class="form-control" style="width:40%; margin-right:10px; display:inline-block;">${vo.gds_odd}</span>
									<span class="form-control" style="width:40%; display:inline-block;">${vo.gds_buytf}</span>
								</div>
								<div class="form-group">
